...
\usepackage[square, sort,numbers]{natbib} % Use the natbib reference package -
% read up on this to edit the reference style; if you want text (e.g. Smith et al., 2012) for the in-text references (instead of numbers), remove 'numbers'
...
\emph{Author:}
\href{http://pablohernandezcerdan.wordpress.com}{\authornames} % Author name -
% remove the \href bracket to remove the link

\begin{minipage}{0.4\textwidth}
\begin{flushright} \large
\emph{Supervisor:} 
\href{http://www.biophysicis.ac.nz}{\supname} % Supervisor name - remove the
\cosupnameA
...
\large \textit{A report submitted in fulfilment of the requirements for the \\
 first year confirmation of the degree of \degreename}\\[0.3cm] % University
% requirement text
\textit{in the}\\[0.4cm]
