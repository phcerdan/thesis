...
distance.
The Hamiltonian with this force $f_B$ in transverse coordinates :
...
chain constituents completely \citep{hsu_breakdown_2011}. For very stiff polymer
...
share the same non-linear behaviour at high strains: strain-stiffening. In plain words, the higher your strain is, tougher
the material becomes or alternatively: the more you pull, the harder is to
pull more. The universal behavior in biopolymers may have an evolutionary
origin, due to the role of the strain-stiffening in biological functions such as cell motility
...
\emph{Note: Ampliation of this topics will be done in function of future needs.
