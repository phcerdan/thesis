...
We fit the graph data generated in the analysis to statistical distributions depedning on the propertiy, as described in \autoref{sec:statistical_distributions_of_graph_properties}.
...
It uses the python script  \citetitle*{phcerdan_fit_to_distribution_from_data_2018} \cite{phcerdan_fit_to_distribution_from_data_2018}.
